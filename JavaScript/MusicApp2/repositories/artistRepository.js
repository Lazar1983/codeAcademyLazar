function ArtistRepository() {
    ...
    this.getArtist = async function (hash) {
        ...
        try {
            ...
            hash + "&api_key=7aa71cb9c109a121032c506f18055880&format=json");
    ...
    this.getTopAlbums = async function(hash){
        ...
        try {
            ...
            hash +"&api_key=7aa71cb9c109a121032c506f18055880&format=json&limit=5");
            result = await response.json();
    ...
    this.searchArtist = async function (name){
        ...
        try{
            ...
            name +  "&api_key=7aa71cb9c109a121032c506f18055880&format=json&limit=5");
